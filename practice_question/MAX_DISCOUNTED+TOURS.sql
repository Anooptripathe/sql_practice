...
-- Write a query to print maximum number of discounted tours any 1 family in the Families table can choose.
...
Select MAX(discounted_tours) as discounted_tours from
(Select f.NAME as Name,count(1) as discounted_tours
from FAMILIES f
