/*Given a list of projects and employees mapped to each project, calculate by the amount of project budget allocated to
 each employee. The output should include the project title and the project budget rounded to the closest integer. 
...
INSERT INTO ms_projects VALUES (1, 'Project1',  29498),(2, 'Project2',  32487),(3, 'Project3',  43909),
(4, 'Project4',  15776),(5, 'Project5',  36268),(6, 'Project6',  41611),(7, 'Project7',  34003),(8, 'Project8',  49284),
...
Select p.title as project_title,round(p.budget/count(e.emp_id)) as budget_per_employee
from ms_projects p
join ms_emp_projects e
on p.id=e.project_id
group by p.title,p.budget,e.emp_id
